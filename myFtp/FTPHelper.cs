            ...
            using (var stream = response.GetResponseStream())
            {
                using (var sr = new StreamReader(stream))
                {
                    ...
                    while ((line = sr.ReadLine()) != null)
                    {
                        ...
                        //drwx------ 1 user group              0 Dec 14 16:35 $RECYCLE.BIN  
                        //DateTime dtDate = DateTime.ParseExact(line.Substring(39, 6), "M d", null);
                        //DateTime dtDateTime = DateTime.Parse(dtDate.ToString("yyyy-MM-dd") + line.Substring(46, 9));
